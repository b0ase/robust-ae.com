      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">
            5-Day Development Plan (40h, £400)
          </h2>
          <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
            <li><strong>Day 1:</strong> Inline Editing Core — 8h (£100)</li>
            <li><strong>Day 2:</strong> Asset & CV Management — 8h (£100)</li>
            <li><strong>Day 3:</strong> Tiny Revision History (Undo) — 8h (£100)</li>
            <li><strong>Day 4:</strong> Real Traffic Metrics &mdash; 8h (£100)</li>
            <li><strong>Day 5:</strong> Polish, Testing & Deployment — 8h (£100)</li>
          </ul>
        </section>

      ...
      <header className="bg-gray-800 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <span className="bg-yellow-500 text-gray-900 px-2 py-1 rounded text-sm font-medium">Admin</span>
          </div>
          <div className="flex items-center space-x-4">
            <button 
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">{pageViews.home}</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${(pageViews.home / (pageViews.home + pageViews.services + pageViews.contact)) * 100}%` }}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
                  <span className="text-gray-700 dark:text-gray-300">Services</span>
                  <span className="font-semibold text-gray-900 dark:text-white">{pageViews.services}</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white">{pageViews.contact}</span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <div>
                <p className="text-gray-700 dark:text-gray-300 mb-1">Last Edited</p>
                <p className="font-semibold text-gray-900 dark:text-white">
                  {lastEdited ? new Date(lastEdited).toLocaleString() : 'No edit history found'}
                </p>
              </div>
              <div>
                <p className="text-gray-700 dark:text-gray-300 mb-1">Content Sections</p>
                <div className="flex space-x-2">
                  <span className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-1 rounded text-xs">Hero</span>
                  <span className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-1 rounded text-xs">Services</span>
                  <span className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-1 rounded text-xs">Mission</span>
                  <span className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-1 rounded text-xs">Contact</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-blue-600 text-white font-semibold px-4 py-2 rounded hover:bg-blue-700 transition flex items-center justify-center space-x-2"
              >
              ...
              <Link 
                href="/newsite" 
                className="w-full bg-gray-600 text-white font-semibold px-4 py-2 rounded hover:bg-gray-700 transition flex items-center justify-center space-x-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">
            5-Day Development Plan (40h, £400 + Supabase costs)
          </h2>
          <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
            <li><strong>Day 1:</strong> Database Integration & Supabase Setup — 8h (£100) <em>(note: Supabase usage beyond free tier may incur costs)</em></li>
            <li><strong>Day 2:</strong> Real Traffic Metrics Implementation — 8h (£100)</li>
            <li><strong>Day 3:</strong> AI Content & Image POC (testimonial generation) — 8h (£100)</li>
            <li><strong>Day 4:</strong> Dashboard Polish, Testing & Deployment — 8h (£100)</li>
            <li><strong>Day 5:</strong> Buffer + Documentation + Environment Review — 8h (£100)</li>
          </ul>
        </section>
        ...
        {content && (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
            <h2 className="text-2xl font-semibold mb-6 text-gray-800 dark:text-white border-b dark:border-gray-700 pb-2">
              Content Preview
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-medium mb-2 text-gray-800 dark:text-white flex items-center">
                  <span className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mr-2 text-blue-600 dark:text-blue-400">H</span>
                  Hero Section
                </h3>
                <div className="pl-10">
                  <p className="font-semibold text-gray-800 dark:text-white">{content.hero.title}</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 line-clamp-2">{content.hero.subtitle}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="pl-10">
                  <p className="font-semibold text-gray-800 dark:text-white">{content.services.introTitle}</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 line-clamp-2">{content.services.introText}</p>
                  <div className="mt-2">

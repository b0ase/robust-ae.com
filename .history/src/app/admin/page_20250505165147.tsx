...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Admin Header */}
      <header className="bg-black text-white p-4 border-b border-b0ase-card-border">
        <div className="container mx-auto flex flex-col sm:flex-row sm:justify-between sm:items-center">
          <div className="flex items-center justify-between mb-4 sm:mb-0">
            <div className="flex items-center space-x-4">
              <Link href="/newsite" className="text-xl md:text-2xl font-bold">robust-ae.com</Link>
              <span className="border border-gray-700 bg-transparent text-white px-2 py-1 text-sm font-medium">Admin</span>
            </div>
            <button 
              onClick={handleLogout}
              className="border border-gray-600 hover:bg-gray-800 text-white px-3 py-1 sm:hidden transition text-sm"
            >
              Logout
            </button>
          </div>
          <div className="hidden sm:flex sm:items-center sm:space-x-4">
            <button 
              onClick={handleLogout}
              className="border border-gray-600 hover:bg-gray-800 text-white px-4 py-2 transition"
            >
              Logout
            </button>
          </div>
      ...
      <main className="container mx-auto px-4 py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          {/* Page Views Card */}
          <div className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border">
          ...
          <div className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full border border-gray-600 text-white font-medium px-4 py-2 hover:bg-gray-800 transition flex items-center justify-center space-x-2"
              >
              ...
              <Link 
                href="/newsite" 
                className="w-full border border-gray-700 text-white font-medium px-4 py-2 hover:bg-gray-800 transition flex items-center justify-center space-x-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        <section className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border mb-6 md:mb-8">
              ...
              <div className="ml-9 mt-2">
                ...
                <div className="mt-4 pt-3 border-t border-gray-700">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        className="text-xs border border-gray-600 text-white px-2 py-1 hover:bg-gray-800 disabled:opacity-50"
                      >
                        Save
                      </button>
                    </div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 text-sm bg-black border border-gray-700 focus:outline-none focus:border-gray-600 text-white"
        ...
        {content && (
          <div className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border mb-6 md:mb-8">
        ...
        <section className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border mb-6 md:mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <button 
                className="border border-gray-600 text-white px-4 py-2 font-medium hover:bg-gray-800 transition disabled:opacity-50"
                disabled
              >
                Coming Soon
              </button>
        ...
        <section className="bg-b0ase-card p-4 md:p-6 rounded-lg border border-b0ase-card-border">

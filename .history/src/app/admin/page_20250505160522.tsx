    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          ...
          <p className="mb-4 text-gray-600 dark:text-gray-400 text-sm italic">A complete solution to elevate your online presence with enterprise-grade data management, analytics, and AI integration.</p>
          
          <div className="space-y-6 mt-4">
            <div>
              <h3 className="text-lg font-semibold flex items-center text-blue-600 dark:text-blue-400">
                <span className="bg-blue-100 dark:bg-blue-900 w-7 h-7 rounded-full flex items-center justify-center mr-2 text-blue-600 dark:text-blue-400">1</span>

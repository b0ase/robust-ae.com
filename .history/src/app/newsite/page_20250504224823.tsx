...
export default function NewSitePage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-gray-800 shadow-md">
        <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <div className="space-x-4 flex items-center">
            ...
            >
              {theme === 'light' ? (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /></svg> // Moon icon
              ) : (
      ...
      {/* Hero Section (Add dark mode styles) */}
      ...
      <div className="container mx-auto px-4 py-8">
       ...
       {/* Footer Section (Add dark mode styles) */}

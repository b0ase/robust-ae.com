              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2 text-center mt-6">
                  <button
                    ...
                    className="bg-gray-50 dark:bg-base-card border border-gray-200 dark:border-base-card-border px-4 py-2 text-gray-700 dark:text-base-blue hover:text-gray-900 dark:hover:text-white transition-colors"
                  >
                    + Add Testimonial
                  </button>
                </div>

  ...
  return (
    <>
      ...
      <div className={isAuthenticated ? "pt-14" : ""}>
        ...
        {!isAuthenticated && (
          <header className="bg-gray-100 dark:bg-gray-900 py-4 border-b dark:border-gray-800">
            <div className="container mx-auto flex justify-between items-center px-4">
              <Link href="/" className="text-xl font-bold text-gray-900 dark:text-white">Robust AE</Link>
              <button 

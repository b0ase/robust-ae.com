      ...
      <header className="sticky top-0 z-50 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-700 shadow-md">
        ...
        <nav className="container mx-auto px-6 py-2 flex justify-between items-center">
          ...
          <div className="space-x-4 flex items-center">
            ...
            {/* Download CV link */}
            <a href="/images/logos/George_Haworth_CV_23042025.pdf" download className="flex items-center text-sm hover:text-blue-600 dark:hover:text-blue-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1 text-gray-600 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Phone link */}
            <a href="tel:07447544890" className="flex items-center text-sm hover:text-blue-600 dark:hover:text-blue-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1 text-gray-600 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span>07447 544 890</span>
            </a>
            {/* Email link */}
            <a href="mailto:info@robust-ae.com" className="flex items-center text-sm hover:text-blue-600 dark:hover:text-blue-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1 text-gray-600 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">

...
export default function Home() { // Renamed from NewSitePage
  ...
  // Define displayContent earlier - needed for the check
  const displayContent = isAuthenticated ? editableContent : content;

  // If content isn't available AFTER loading, show an error
  if (!displayContent) { // Changed this check to use displayContent
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-bold text-red-600">Error Loading Content</h1>
        <p>The website content could not be loaded. Please try again later or contact support.</p>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      {isAuthenticated && (
        <div className="fixed top-0 left-0 right-0 bg-gray-800 text-white z-[110] py-3 px-4 shadow-md">
      ...
      <div className={isAuthenticated ? "pt-20" : ""}>
        ...
        {!isAuthenticated && (
          <button 
            ...
            className="fixed bottom-6 right-6 bg-gray-800 border border-gray-700 p-3 rounded-full shadow-lg hover:bg-gray-700 transition z-[90]"
        ...
        <section id="hero" className="bg-b0ase-dark text-center py-12 px-4 md:py-20 md:px-6 border-b border-b0ase-card-border">
          <div className="container mx-auto">
            {/* Hero Image Carousel */}
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {displayContent.services.cards.map((card, index) => (
                <div key={index}>
                  {isAuthenticated ? (
                    <div className="bg-b0ase-card p-5 md:p-6 rounded-lg border border-b0ase-card-border transition-all duration-300 h-full">

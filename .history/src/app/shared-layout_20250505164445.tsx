      ...
      <header className="sticky top-0 z-50 bg-black border-b border-b0ase-card-border">
        <nav className="container mx-auto px-4 py-3 md:px-6 md:py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4 md:hidden">
            <Link href="/" className="bg-b0ase-blue text-white text-sm px-3 py-1 rounded hover:bg-opacity-80 transition">Home</Link>
        ...
        >
          <div className="container mx-auto px-4 py-4 space-y-4">
            <div className="space-y-3">
              <Link 
                href="#services" 
                className="block py-2 text-white hover:text-b0ase-blue"

    ...
    try {
      ...
      if (response.ok) {
        ...
        setContent({
          ...
          challenge: "Our client, a robotics manufacturer, needed a precision motor control system for their new line of collaborative robots. The system required exceptional responsiveness, positional accuracy within ±0.01mm, and the ability to maintain torque control under varying loads. Additionally, the system needed to interface with their existing CAN-based network architecture while meeting stringent safety requirements for human-robot collaboration.",
          solution: "We developed a state-of-the-art motor control solution using the STM32 microcontroller platform. Key features included:\n\n- Field-Oriented Control (FOC) implementation for maximum motor efficiency\n- Dual-core architecture with one core dedicated to real-time control tasks\n- Advanced PID control with auto-tuning capabilities\n- High-resolution positional feedback using magnetic encoders\n- CAN interface for seamless integration with existing systems\n- Current limiting and thermal protection circuits\n- Configurable safety protocols including torque limiting and position constraints\n- Compact design for integration into space-constrained robotic joints",
          results: "The motor controller exceeded all client requirements and is now deployed across their entire line of collaborative robots. The precision achieved allows for delicate tasks that were previously impossible with off-the-shelf controllers. The system's reliability has resulted in zero field failures in over 18 months of operation. Energy efficiency improved by 23% compared to their previous solution, reducing heat generation and extending motor life. The client has commissioned additional variants of the controller for their next-generation industrial automation systems.",
          technologies: ["STM32", "FOC Algorithm", "Real-time Control", "CAN Interface", "Embedded C/C++", "PCB Design", "Motor Physics"],
          imageSrc: "/images/projects/Precision_Motor_Controller.jpg",
          additionalImages: [
            {
              src: "/images/projects/motor_controller_pcb.jpg",
              alt: "Motor Controller PCB"
            },
            {
              src: "/images/projects/motor_controller_testing.jpg",
              alt: "Performance Testing Setup"
            }
          ],
          testimonial: {

...
export default function ProjectsPage() {
  ...
  /* // Temporarily comment out useEffect to force isAuthenticated=false
  useEffect(() => {
    const storedAuth = sessionStorage.getItem('isAdminAuthenticated');
    // console.log('ProjectsPage: useEffect - sessionStorage isAdminAuthenticated:', storedAuth);
    if (storedAuth === 'true') {
  ...
  */
  ...
  // Call fetchProjects directly or in a separate useEffect
  useEffect(() => {
    fetchProjects();
  ...
  return (
    <>
      ...
      {/* --- Admin Toolbar Added --- */}
      {isAuthenticated && (
        <div className="fixed top-0 left-0 right-0 bg-gray-800 text-white z-70 py-3 px-4 shadow-md"> {/* z-70 should be enough here */}

      ...
      <div>
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center pt-20">
            <MotionWrapper type="slideUp" delay={0.2} viewportOnce={true}>
              {/* Big Logo in Hero */}
        ...
        <section id="services" className="py-20 px-6 bg-black">
          <div className="container mx-auto max-w-6xl">
            <MotionWrapper type="fadeIn" viewportOnce={true}>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {content.services.cards.map((service, index) => (
                <StaggerItem key={index} className="h-full">
                  <div className="bg-b0ase-card p-6 md:p-8 rounded-lg border border-b0ase-card-border hover:border-b0ase-blue transition duration-300 flex flex-col h-full group">
        ...
        <section className="py-20 px-6 bg-b0ase-dark border-y border-b0ase-card-border">
          <div className="container mx-auto max-w-6xl">
            <MotionWrapper type="slideUp" viewportOnce={true}>
          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="space-y-16">
              {content.projects.items.map((project, index) => (
                <MotionWrapper key={index} type="fadeIn" viewportOnce={true}>
                  <div className="group bg-b0ase-card rounded-2xl border border-b0ase-card-border overflow-hidden hover:shadow-2xl hover:shadow-b0ase-blue/10 transition duration-500">
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
              {content.testimonials.items.map((testimonial, index) => (
                <MotionWrapper key={index} type="fadeIn" delay={index * 0.1} viewportOnce={true}>
                  <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-8 rounded-2xl flex flex-col text-left relative h-full">
            ...
            {/* Client Logos Section - Bigger Logos */}
            <div className="border-t border-gray-200 dark:border-gray-800 pt-16">
              ...
              <div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-60">
                {content.testimonials.clients.map((client, index) => (
                  <div key={index} className="w-48 h-24 relative grayscale hover:grayscale-0 transition duration-500 flex items-center justify-center">
                    {client.logoSrc ? (
                      <Image
                        src={client.logoSrc}
                        alt={client.name}
        ...
        <section id="contact" className="py-20 px-4 md:px-6 bg-black relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            ...
            <MotionWrapper type="fadeIn" delay={0.2} viewportOnce={true}>
